...
# Add a new column 'n_tokens' to store the number of tokens for each text
...
# Add a new column 'embeddings' to store the embeddings for each text
...
def create_context(
    ...
    distance_metric = "cosine"  # You can change this to "L1", "L2", or "Linf"

    df['distances'] = distances_from_embeddings(q_embeddings, embeddings_list, distance_metric)
...
def answer_question(
    ...
    try:
        ...
        # Additional processing or usage of response_txt as needed
        # Return the response text
        return response_txt
    except Exception as e:
        print(e)
        # Handle the exception or return an empty string as before
        return ""
